    ...
    >
      <Container>
        ...
        <h3>
          ...
          biotech class. Ever since I did my first PCR I knew this was the right
          field for me. Throughout my junior year my interest deepened until I
          decided to join the lab in which my teacher worked. While starting
          research I realized how a science I loved could be used to help people
          and the environment.
          <br />
